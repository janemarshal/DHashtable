...
public class Finger extends salsa_lite.runtime.Actor implements java.io.Serializable {
    ...
    public Object writeReplace() throws java.io.ObjectStreamException {
        ...
        return new SerializedFinger( this.hashCode(), TransportService.getHost(), TransportService.getPort() );
    }

    public static class RemoteReference extends Finger {
        ...
        public Object writeReplace() throws java.io.ObjectStreamException {
            return new SerializedFinger( hashCode, host, port);
        }
    }

    public static class SerializedFinger implements java.io.Serializable {
        int hashCode;
        String host;
        int port;

        SerializedFinger(int hashCode, String host, int port) { this.hashCode = hashCode; this.host = host; this.port = port; }

        public Object readResolve() throws java.io.ObjectStreamException {
            int hashCode = Hashing.getHashCodeFor(this.hashCode, this.host, this.port);
            synchronized (LocalActorRegistry.getLock(hashCode)) {
                Finger actor = (Finger)LocalActorRegistry.getEntry(hashCode);
                if (actor == null) {
    ...
    public Finger() { super(); }
    public Finger(int stage_id) { super(stage_id); }
    ...
    public Object invokeMessage(int messageId, Object[] arguments) throws RemoteMessageException, TokenPassException, MessageHandlerNotFoundException {
        switch(messageId) {
            ...
            case 2: return getStart();
            case 3: setStart( (ChordKey)arguments[0] ); return null;
            case 4: return getNode();
            case 5: setNode( (ChordNode)arguments[0] ); return null;
    ...
    public void invokeConstructor(int messageId, Object[] arguments) throws RemoteMessageException, ConstructorNotFoundException {
        switch(messageId) {
            case 0: construct( (ChordKey)arguments[0], (ChordNode)arguments[1] ); return;
            default: throw new ConstructorNotFoundException(messageId, arguments);
        }
    }

    public void construct(ChordKey start, ChordNode node) {
        this.start = start;
        this.node = node;
    }
    ...
    public ChordKey getStart() {
        return (ChordKey)DeepCopy.deepCopy( start );
    }
    ...
    public static Finger construct(int constructor_id, Object[] arguments) {
        Finger actor = new Finger();
        StageService.sendMessage(new Message(Message.CONSTRUCT_MESSAGE, actor, constructor_id, arguments));
        return actor;
    }

    public static Finger construct(int constructor_id, Object[] arguments, int target_stage_id) {
        Finger actor = new Finger(target_stage_id);
